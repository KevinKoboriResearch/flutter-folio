    ...
    return Container(
      ...
      child: LayoutBuilder(builder: (_, constraints) {
        return AutoSizeText(
          ...
          stepGranularity: 1,
          textScaleFactor: 1.0,
          presetFontSizes: [12, 16, 20, 24, 28, 32, 36, 40, 48, 56, 64, 72, 80, 96],
          // onTap: () {
          //   if (widget.isSelected) {
          //     // Do something when selected
          //   }
          // },
          overflowReplacement: widget.isSelected
              ? InlineTextEditor(
                  widget.item.data,
                  autoFocus: false,
                  alignVertical: TextAlignVertical.center,
                  align: widget.item.boxStyle?.align ?? TextAlign.left,
                  ...
                  style: TextStyle(
                      fontSize: 14,
                      fontFamily: boxFontToFamily(widget.item.boxStyle?.font)), // Adjust fontSize as needed
                )
              : Container(
                  ...
                  child: SizedBox(
                    ...
                    child: Text(
                      StringUtils.defaultOnEmpty(widget.item.data, promptText),
                      style: TextStyle(
                          fontSize: 14,
                          fontFamily: boxFontToFamily(widget.item.boxStyle?.font)), // Adjust fontSize as needed
                      maxLines: 99,
